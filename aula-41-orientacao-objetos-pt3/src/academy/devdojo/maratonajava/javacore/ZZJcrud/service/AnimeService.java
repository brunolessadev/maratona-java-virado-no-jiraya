...
public class AnimeService {
    ...
    private static void findByName() {
        ...
        for (int i = 0; i < animes.size(); i++) {
            ...
            System.out.printf("[%d] - %s %d %s%n", i, anime.getId(), anime.getName(), anime.getEpisodes(), anime.getProducer().getName());
        }
    }
    ...
    private static void save() {
        ...
        String name = SCANNER.nextLine();
        System.out.println("Type the name of episodes");
    ...
    private static void update() {
        ...
        Optional<Anime> animeOptional = AnimeRepository.findId(Integer.parseInt(SCANNER.nextLine()));
