...
public class LocaleTest01 {
    public static void main(String[] args) {
        ...
        Locale localeICH = new Locale("it","CH");
        ...
        DateFormat df2 = DateFormat.getDateInstance(DateFormat.FULL,localeICH);
        ...
        System.out.println(localeICH.getDisplayCountry());
        System.out.println(localeICH.getDisplayCountry(localeJapan));
    }
}
